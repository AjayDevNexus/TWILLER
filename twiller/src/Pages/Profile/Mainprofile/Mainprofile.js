...
const Mainprofile = ({ user }) => {
  ...
  const avatarstyles = ["avataaars","micah","bottts","pixel-art","adventurer","open-peeps","lorelei","shapes"];
  ...
  const handleuploadcoverimage = (e) => {
    ...
    axios
      ...
      .catch((e) => {
        console.log(e);
        window.alert("Error uploading cover image");
        setisloading(false);
      });
  };
  ...
  const handleuploadprofileimage = (e) => {
    ...
    axios
      ...
      .catch((e) => {
        console.log(e);
        window.alert("Error uploading profile image");
        setisloading(false);
      });
  };
  ...
  const handleSelectAvatar = () => {
    ...
    fetch(`http://localhost:5000/userupdate/${user?.email}`, {
      ...
      .catch((e) => {
        console.log(e);
        window.alert("Error updating avatar");
        setisloading(false);
      });
  };
    ...
    <div>
          ...
          <div>
            ...
            <div className="avatar-img">
              <div className="avatarContainer">
                ...
                <Button onClick={handleOpenModal} className="avatarbutton">
                      Choose Avatar
                    </Button>
              </div>
      ...
      <Modal open={openModal} onClose={handleCloseModal}>
        ...
        >
            ...
            <p id="msg">MORE AVATRAAS VIST THIS WEBSITE ENTER NAME OF AVATAR</p>
            
          <Button variant="contained"><a href="https://www.dicebear.com/playground/">CLICK HERE</a></Button>
          <TextField
            label="Avatar"
            value={avatarSeed}
